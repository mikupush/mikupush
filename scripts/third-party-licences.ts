...
Miku Push! is built using several open-source libraries, runtimes, and frameworks. You can find their licenses listed below, organized by license.
...
const htmlOutput = mdConverter.makeHtml(output)

fs.writeFileSync('THIRD_PARTY_LICENSES.md', output)
fs.writeFileSync('src-tauri/assets/THIRD_PARTY_LICENSES.html', htmlOutput)
